...
const HeroSection = () => {
  ...
  return (
    <section className="w-full relative min-h-screen lg:h-[940px] overflow-hidden bg-gradient-to-b from-mainColor to-transparent">
      <div className="flex absolute w-11/12 md:w-5/6 items-center inset-0 h-full mx-auto">
        <div className="w-full md:w-[55%] text-center md:text-left text-secCol flex flex-col gap-y-10">
          <div className="flex flex-col text-2xl uppercase">
            <h4 className="font-semibold">{t("event")}</h4>
            <h4 className="font-regular">10 June | 15 June 2024</h4>
          </div>
