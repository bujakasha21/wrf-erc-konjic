...
export default function AccommodationWrapper() {
  ...
  return (
    <section className="w-full h-[100vh] bg-black/40 z-10 relative overflow-hidden">
      <div className="z-10 bg-titleCol  opacity-80 absolute inest-0 w-full h-full px-8 py-14 md:px-28 md:py-24 flex flex-col text-center md:text-left items-center md:items-center justify-center md:flex-row">
        ...
        <div
          ...
          className="w-full h-full relative  md:translate-x-0 flex justify-center md:block"
        >
          <Image
