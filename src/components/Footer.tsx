      ...
      >
        ...
        <div className="flex mt-8 flex-col md:flex-row md:justify-between">
          <p className="w-full md:w-2/3 text-gray-400">
            Headquarters: Castione Andevenno Via Nazionale ( Railway station )
            <br />
            Registered office: Largo Pedrini 3 Sondrio <br />
        ...
        <div className="flex flex-col">
          ...
          <p className="w-full text-center my-12 text-textColor">
            Copyright © 2024 <Link href="https://mmu.ba">MMU</Link> && 00 Studio
          </p>
        </div>
      </motion.div>
    </footer>
