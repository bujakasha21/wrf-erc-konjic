          ...
          <div className="flex mt-24 mb-12 flex-row justify-between items-center">
            ...
            <div className="flex flex-row space-x-8 items-center justify-between">
              <Magnetic>
                ...
                <Link
                  onMouseEnter={() => {
                    setIsHovered((prev) => ({ ...prev, fb: true }));
                  }}
                  onMouseLeave={() => {
                    setIsHovered((prev) => ({ ...prev, fb: false }));
                  }}
                  href="#"
                >
                  <svg
                  ...
                  >
                    <path
                      ...
                      fill={`${isHovered.fb ? "#ffba42" : "white"}`}
                    />
                  </svg>
                </Link>
              </Magnetic>
              <Magnetic>
                <Link
                  onMouseEnter={() => {
                    setIsHovered((prev) => ({ ...prev, ins: true }));
                  }}
                  onMouseLeave={() => {
                ...
                >
                  ...
                  >
                    <path
                      ...
                      fill={`${isHovered.ins ? "#ffba42" : "white"}`}
                    />
                    <path
              ...
              <Magnetic>
                ...
                <Link
                  onMouseEnter={() => {
                    setIsHovered((prev) => ({ ...prev, yt: true }));
                  }}
                  onMouseLeave={() => {
                    setIsHovered((prev) => ({ ...prev, yt: false }));
                  }}
                  href="#"
                >
                  <svg
                  ...
                  >
                    <path
                      ...
                      fill={`${isHovered.yt ? "#ffba42" : "white"}`}
                    />
                  </svg>
                </Link>
              </Magnetic>
